...
public class NodeController {
    ...
    public void addNodes() {
    	List<Node> nodes = new ArrayList<Node>(Arrays.asList(new Node[] {
        		...
        		new Node("Cassiet", "Clement", 1, LocalDate.of(1899, 07, 9), "Péîs", "Tournant-En-Brie",  userService.getUser(2),2),
        		new Node("Gautier", "Jordan", 1, LocalDate.of(2002, 11, 21), "Nouvel-Zélande", "Paris Hilton", userService.getUser(3),1),
