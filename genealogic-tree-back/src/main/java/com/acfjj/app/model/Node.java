...
public class Node {
	...
	public Node(Long id, String lastName, String firstname, int gender, LocalDate dateOfBirth, String countryOfBirth, String cityOfBirth, User createdBy, Node parent1, Node parent2, int privacy, String nationality, String adress, int postalCode, String profilPictureUrl) {
	    this(id, new PersonInfo(lastName, firstname, gender, dateOfBirth, countryOfBirth, cityOfBirth, false, nationality, adress, postalCode, profilPictureUrl),
	    	 createdBy, parent1, parent2, privacy);
	}
	public Node(Long id, String lastName, String firstname, int gender, LocalDate dateOfBirth, String countryOfBirth, String cityOfBirth, User createdBy, Node parent1, int privacy, String nationality, String adress, int postalCode, String profilPictureUrl) {
	    this(id, lastName, firstname, gender, dateOfBirth, countryOfBirth, cityOfBirth, createdBy, parent1, null, privacy, nationality, adress, postalCode, profilPictureUrl);
	}
	public Node(Long id, String lastName, String firstname, int gender, LocalDate dateOfBirth, String countryOfBirth, String cityOfBirth, User createdBy, int privacy, String nationality, String adress, int postalCode, String profilPictureUrl) {
	    this(id, lastName, firstname, gender, dateOfBirth, countryOfBirth, cityOfBirth, createdBy, null, null, privacy, nationality, adress, postalCode, profilPictureUrl);
	}
	...
	public boolean isOrphan() {
		return (Objects.isNull(this.getParent1()) && Objects.isNull(this.getParent2()) && 
				this.getSiblings().isEmpty() && Objects.isNull(this.getPartner()) && this.getExPartners().isEmpty()
				&& !this.getHasChild() && getPersonInfo().isOrphan() && this.getTreeNodes().isEmpty());
	}	
	...
	public static Node CastAsNode(LinkedHashMap<String, String> data, User createdBy, Node parent1, Node parent2, Node partner) {
...
//				: Constants.DEFAULT_PP_URL;
		...
		Node node =new Node (id, lastname, firstname, gender, dateOfBirth, countryOfBirth, 
				cityOfBirth, createdBy,  parent1,  parent2,  privacy, nationality, adress, postalCode, ppUrl);
